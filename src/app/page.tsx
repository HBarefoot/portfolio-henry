    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 1120, margin: "0 auto", padding: "100px 32px" }}>
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.1fr)] gap-16 items-start">
            {/* left: heading + links */}
            <div data-reveal>
              ...
              <p style={{ margin: "22px 0 0", fontSize: 17, lineHeight: 1.6, color: "#9aa3ad" }}>
                I read every message myself. If you&apos;re hiring, include the role, the team, and the outcome
                you&apos;re hiring for — I&apos;ll reply within 24 hours.
              </p>
